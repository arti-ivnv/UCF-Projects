...
Original file is located at
    https://colab.research.google.com/drive/1DkA2tOz0TCKlWefJT_4hRqiQgRZHgUUm
...
(trainX, trainy), (testX, testy) = load_data() # loda train and test data: (trainX, trainy) and (testX, testy)
...
def generate_real_samples(dataset, n_samples):
 	ix = randint(low = 0, high=len(dataset), size=n_samples)	# choose random instances with randit(start=0, end=num of data, sample=n_samples)
...
### compile model ###
	opt = Adam(learning_rate=0.0002, beta_1= 0.5) # lr=0.0002, beta_1=0.5
...
latent_points = generate_latent_points(latent_dim, 25) # 100 (hint:latent_dim), 25 (hint: num of samples)
### generate images
