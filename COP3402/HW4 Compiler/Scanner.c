...
typedef enum
{
  ...
  endsym = 22, ifsym = 23, thensym = 24, whilesym = 25, dosym = 26, callsym = 27,
...
scanner *lex(char *inputfile, int lFlag)
{
  ...
  // Added: "begin", "end"
  char *word[] = {"const", "var", "if", "procedure", "call", "then", "else", "while", "do", "read", "write", "odd", "null", "begin", "end"};


// callsym = 27, elsesym = 33, procsym = 30
  char tokenNames[][15] = {
  ...
  int rw_num[] = {constsym, varsym, ifsym, procsym, callsym, thensym, elsesym, whilesym,
                  dosym, readsym, writesym, oddsym, nulsym, beginsym, endsym};
